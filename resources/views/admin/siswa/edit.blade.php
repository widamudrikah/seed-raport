...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Form Edit Data {{ $siswa->name }}</h1>
    ...
    <div class="container-fluid">
        <form class="card p-4" method="post" action="{{ route('siswa-store') }}">
            ...
            <div class="mb-3">
                ...
                <input value="{{ $siswa->name }}" type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Masukan nama lengkap siswa" value="{{ old('name') }}" required>
            ...
            <div class="mb-3">
                ...
                <input value="{{ $siswa->nisn }}" type="number" class="form-control @error('nisn') is-invalid @enderror" name="nisn" placeholder="Masukan NISN siswa" value="{{ old('nisn') }}" required>
